...
try
{
	...
	<h1 style="color:black;"><center><u>Donor Registration</u> </center></h1>
	<%	
}
	catch(Exception e)
	{}
...
<h2>Password</h2>
<input type="password" placeholder="password" name="donor_password" title="Password must contain: Minimum 8 characters atleast 1 Alphabet and 1 Number"
